...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=7AA2F7&center=true&vCenter=true&width=600&lines=Statistics+Student+%7C+Data+Enthusiast;Python+%C2%B7+SQL+%C2%B7+R;Turning+messy+data+into+practical+decisions" alt="Typing SVG" />
  </a>
</p>

<p align="center">
  Building end-to-end analytics, machine-learning systems, forecasting models, and interactive
  data products that transform complex datasets into practical decisions.
</p>
...
I'm a Statistics student and data practitioner focused on building end-to-end
...
- 🌱 Currently deepening my skills in **time-series forecasting** and **MLOps
  practices** (drift monitoring, CI/CD for ML)
- 📊 Interested in customer analytics, fraud detection, anomaly detection, and
  data-quality tooling
- 🎯 Open to **data analyst internships**, research collaborations, and
  practical data-product projects
- 💬 Ask me about pandas, scikit-learn, Shiny, or SARIMA/XGBoost hybrid models
...
- **94.83%** Precision · **77.46%** Recall · **85.27%** F1 Score
- Extra Trees classifier with calibrated decision threshold
...
<p align="center">
  ...
  <br/>
  <img src="https://komarev.com/ghpvc/?username=Salajalaludin&label=Profile+Views&color=1A1B27&style=for-the-badge" alt="Profile Views"/>
</p>
